...
if __name__ == '__main__':
        activity1 = Activity({2: 6})
        activity2 = Activity({3: 4, 4: 3, 6: 6})
        activity3 = Activity({5: 2})
        activity4 = Activity({9: 4})
        activity5 = Activity({6: 3})
        activity6 = Activity({7: 2, 8: 4})
        activity7 = Activity({11: 4})
        activity8 = Activity({11: 1})
        activity9 = Activity({10: 1})
        activity10 = Activity({11: 4})
        activity11 = Activity(None)
